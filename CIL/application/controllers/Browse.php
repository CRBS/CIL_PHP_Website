                ...
                if($count > 0)
                {
                    ...
                    if(isset($hit->_source->Query_string))
                    {
                        ...
                        if(isset($result->hits->total))
                        {
                         ...
                         {
                             $data['centered_interactive_cell'] = true;
                             $this->load->view('main_page2/lysosome', $data);
                         }
                         else if(strcasecmp($input, "Mitochondrion") == 0)
                         {
                             $data['centered_interactive_cell'] = true;
                         ...
                         else if(strcasecmp($input, "Nucleus") == 0)
                         {
                             $data['centered_interactive_cell'] = true;
                             $this->load->view('main_page2/nucleus', $data);
                         }
                         else if(strcasecmp($input, "Vacuole") == 0)
                         {
                             $data['centered_interactive_cell'] = true;
