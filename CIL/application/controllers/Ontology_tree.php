...
class Ontology_tree extends REST_Controller
{
   ...
   public function mouse_gross_anatomies_get()
   {
       $id="";
       $result = NULL;
       $temp = $this->input->get('id',TRUE);
       ...
       $urlPrefix = $this->config->item("ontology_prefix");
       $type = $this->config->item("mouse_gross_anatomies_type");
       $root_config_name = "mouse_gross_anatomy_roots";
       $this->handle_multiple_roots($urlPrefix,$type,$id,$root_config_name); 
   }
   
   public function mouse_pathologies_get()
   {
       $id="";
       $result = NULL;
       $temp = $this->input->get('id',TRUE);
       ...
       $urlPrefix = $this->config->item("ontology_prefix");
       $type = $this->config->item("mouse_pathologies_type");
       $root_config_name = "mouse_pathology_roots";
       $this->handle_multiple_roots($urlPrefix,$type,$id,$root_config_name); 
   }
   ...
   public function teleost_anatomies_get()
   {
       $id="";
       $result = NULL;
       $temp = $this->input->get('id',TRUE);
       ...
       $urlPrefix = $this->config->item("ontology_prefix");
       $type = $this->config->item("teleost_anatomies_type");
       $root_config_name = "teleost_anatomy_roots";
       $this->handle_multiple_roots($urlPrefix,$type,$id,$root_config_name); 
   }
   
   public function xenopus_anatomies_get()
   {
       $id="";
       $result = NULL;
       $temp = $this->input->get('id',TRUE);
       ...
       $urlPrefix = $this->config->item("ontology_prefix");
       $type = $this->config->item("xenopus_anatomies_type");
       $root_config_name = "xenopus_anatomy_roots";
       $this->handle_multiple_roots($urlPrefix,$type,$id,$root_config_name); 
   }
   
   public function zebrafish_anatomies_get()
   {
       $id="";
       $result = NULL;
       $temp = $this->input->get('id',TRUE);
       ...
       $urlPrefix = $this->config->item("ontology_prefix");
       $type = $this->config->item("zebrafish_anatomies_type");
       $root_config_name = "zebrafish_anatomy_roots";
       $this->handle_multiple_roots($urlPrefix,$type,$id,$root_config_name); 
   }   
