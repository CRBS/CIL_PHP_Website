    ...
    <div class="row" id="browse_header">
        ...
        <div class="col-md-6">
           <div class="pull-right">
            <a href="/browse/celltype?direction=desc&amp;sort=name&amp;view_type=grid" class="not_expected_results">Show Thumbnails</a>
           </div>
        </div>
        ...
        <th scope="col">
          <a class="cil_16_font_no_color_bold" target="_self" href="<?php
             if(isset($reversed_direction))
                echo "/browse/celltype?direction=".$reversed_direction."&sort=name&view_type=column";
             else
                echo "#";
             ?>">Name</a></th>
        <th scope="col">
           ...
           <?php
             if(isset($sort) && strcmp($sort,"name")==0)
                echo "/browse/celltype?direction=desc&sort=image_count&view_type=column";   
             else if(isset($reversed_direction))
                echo "/browse/celltype?direction=".$reversed_direction."&sort=image_count&view_type=column";
             else
                echo "#";
             ?>">Images</a>
        </th>
...
<?php
                ...
                isset($item->_source->Total))
            {
               echo "\n<tr>";
               echo "\n<td width=\"50%\">".
                       "<a href=\"/browse/celltype/".$item->_source->Name."\" class=\"cil_16_font_no_color\" target=\"_self\">".
