...
<?php
            ...
            {
                echo "<a href=\"/browse/celltype?direction=".$direction.
 ...
 ?>
            ...
            <a href="/browse/celltype?direction=desc&amp;sort=name&amp;view_type=column" class="not_expected_results">Hide Thumbnails</a>
           </div>
        </div>
