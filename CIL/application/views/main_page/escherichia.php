<span class="cil_title">Explore <i>Escherichia coli</i></span>
<div class="row">
    <div class="col-md-7">
    ...
    <div class="col-md-3 row_no_gap_right">
         <ul class="list-group">
            ...
            <li id="Flagella" class="list-group-item"><a href="/images?k=flagella&simple_search=Search" class="anchor_blue">Flagella</a></li>
