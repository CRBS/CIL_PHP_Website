<!-------------------------Imaging Methods------------------------------------>
                <div class="row top-buffer" id="browse_header">
                    ...
                    <div class="col-md-4">
                    <span class="cil_18_regular_font">Imaging Methods</span>
                    </div>
                    <div class="col-md-4">
                    </div>
                ...
                <div  class="row"  style="display: none" id="ImagingMethods">
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_item_type_bim" name="image_search_parms[item_type_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_image_mode_bim" name="image_search_parms[image_mode_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_visualization_methods_bim" name="image_search_parms[visualization_methods_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_source_of_contrast_bim" name="image_search_parms[source_of_contrast_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_relation_to_intact_cell_bim" name="image_search_parms[relation_to_intact_cell_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_processing_history_bim" name="image_search_parms[processing_history_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_preparation_bim" name="image_search_parms[preparation_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
                    ...
                    <div class="col-md-12">
                        <div class="row top-buffer">
                            ...
                            <div class="col-md-5">
                                <input id="image_search_parms_parameter_imaged_bim" name="image_search_parms[parameter_imaged_bim]" style="width: 100%" type="text" value="" class="acInput form-control">
                            </div>
                            <div class="col-md-4  cil_text_box_align">
